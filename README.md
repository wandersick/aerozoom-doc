...
This section is for users who use the [unattended installer](https://github.com/wandersick/az-autohotkey-silent-setup) downloaded [here](https://github.com/wandersick/aerozoom/releases) or [Chocolatey](https://chocolatey.org/packages/aerozoom) installation option.
